...
estilo.configure("Vertical.TProgressbar", foreground='black', background='#FF9E00',troughcolor='black',
	bordercolor='black',lightcolor='#FF9E00', darkcolor='#FF9E00')
...
estilo1.configure("Horizontal.TProgressbar", foreground='red', background='black',troughcolor='grey',
																bordercolor='white',lightcolor='white', darkcolor='black')
...
texto = Label(frame2, bg='black', fg='#FF9E00', width=5)
texto.grid(row=0,column=8)

nombre = Label(frame2, bg='black', fg='white', width=55)
nombre.grid(column=0, row=1, columnspan=8, padx=5)
cantidad = Label(frame2, bg='black', fg='white')
...
boton2 = Button(frame2, image= imagen2, bg='white', command=iniciar)
boton2.grid(column=1, row=2, pady=10)
boton3 = Button(frame2,image= imagen3, bg='white', command=stop)
boton3.grid(column=2, row=2, pady=10)
boton4 = Button(frame2,image= imagen4, bg='white', command=pausa)
boton4.grid(column=3, row=2, pady=10)
boton5 = Button(frame2, image= imagen5, bg='white',command=continuar)
boton5.grid(column=4, row=2, pady=10)
atras = Button(frame2, image= imagen6, bg='white',command= retroceder)
atras.grid(column=5, row=2, pady=10)
adelante = Button(frame2, image= imagen7, bg='white',command=adelantar)
...
style = ttk.Style()
style.configure("Horizontal.TScale", bordercolor='grey', troughcolor='black', background= 'white',
	foreground='white',lightcolor='white',darkcolor='black')

nivel = Label(frame2, bg='black', fg='white', width=3)
